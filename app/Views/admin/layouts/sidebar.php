    ...
    <div class="user-card d-flex d-md-none align-items-center justify-content-between justify-content-md-center pb-4">
      <div class="d-flex align-items-center">
        <div class="avatar-lg me-4">
          <img src="/admin-assets/assets/img/team/profile-picture-3.jpg" class="card-img-top rounded-circle border-white" alt="Admin">
        </div>
        <div class="d-block">
          <h2 class="h5 mb-3">Hi, Admin</h2>
          <a href="/dang-xuat" class="btn btn-secondary btn-sm d-inline-flex align-items-center">
    ...
    <ul class="nav flex-column pt-3 pt-md-0">
      <li class="nav-item">
        <a href="/admin" class="nav-link d-flex align-items-center">
          <span class="sidebar-icon">
            <img src="/assets/img/logo.svg" alt="Logo" style="height: 30px;" class="me-2">
          </span>
          <span class="sidebar-text font-weight-bold fs-5">FlowerShop</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a href="/admin/products" class="nav-link">
          ...
          <span class="sidebar-text">Sản phẩm Hoa</span>
        </a>
      </li>

      <li class="nav-item <?= str_contains($_SERVER["REQUEST_URI"] ?? "", "/admin/categories") ? "active" : "" ?>">
        <a href="/admin/categories" class="nav-link">
          <span class="sidebar-icon">
            <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 11H5m14 0a2 2 0 012 2v6a2 2 0 01-2 2H5a2 2 0 01-2-2v-6a2 2 0 012-2m14 0V9a2 2 0 00-2-2M5 11V9a2 2 0 002-2m0 0V5a2 2 0 012-2h6a2 2 0 012 2v2M7 7h10"></path></svg>
          </span>
          <span class="sidebar-text">Danh mục Hoa</span>
        </a>
      </li>

      <li class="nav-item <?= str_contains($_SERVER["REQUEST_URI"] ?? "", "/admin/customers") ? "active" : "" ?>">
      ...
      <li class="nav-item <?= str_contains($_SERVER["REQUEST_URI"] ?? "", "/admin/reviews") ? "active" : "" ?>">
        <a href="/admin/reviews" class="nav-link">
          <span class="sidebar-icon">
            <svg class="icon icon-xs me-2" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M18 13V5a2 2 0 00-2-2H4a2 2 0 00-2 2v8a2 2 0 002 2h3l3 3 3-3h3a2 2 0 002-2zM5 7a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1zm1 3a1 1 0 100 2h6a1 1 0 100-2H6z" clip-rule="evenodd"></path></svg>
          </span>
          <span class="sidebar-text">Đánh giá & Bình luận</span>
        </a>
      </li>

      <li class="nav-item <?= str_contains($_SERVER["REQUEST_URI"] ?? "", "/admin/posts") ? "active" : "" ?>">
        <a href="/admin/posts" class="nav-link">
          <span class="sidebar-icon">
            <svg class="icon icon-xs me-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 20H5a2 2 0 01-2-2V6a2 2 0 012-2h10a2 2 0 012 2v1m2 13a2 2 0 01-2-2V7m2 13a2 2 0 002-2V9.5a2.5 2.5 0 00-2.5-2.5H15"></path></svg>
          </span>
          <span class="sidebar-text">Bài viết / Tin tức</span>
        </a>
      </li>

      <li class="nav-item <?= str_contains($_SERVER["REQUEST_URI"] ?? "", "/admin/coupons") ? "active" : "" ?>">
      ...
      <li class="nav-item">
        <a href="/" target="_blank" class="nav-link d-flex align-items-center">
          ...
          <span class="sidebar-text">Xem Website</span>
        </a>
      </li>
    </ul>
  </div>
